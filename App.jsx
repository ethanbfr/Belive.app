...
const AI_R=(q,avg)=>{
  ...
  // ── HORS SUJET ─────────────────────────────────────────────────────────────
  const horssujet=[
    "cuisine","recette","manger","restaurant","voiture","sport","football","foot","médecin","santé","amour","couple","relation","météo","voyage","vacances","école","bac","étude","emploi","cv","droit","avocat","impôt","immobilier","appartement","loyer","crypto","bitcoin","bourse","action","investissement","psychologie","dépression","anxiété","religion","politique","guerre","actualité","news","film","série","musique","chanson","mode","vêtement","shopping"
  ];
  if(horssujet.some(h=>l.includes(h)))
    return`❌ Cette question ne concerne pas le live streaming ni la création de contenu.\n\nJe suis uniquement spécialisé dans :\n🎮 TikTok Live, Twitch, YouTube Live\n📈 Croissance et monétisation de streamers\n🤝 Partenariats créateurs\n\nPour toute autre demande, contacte notre agence directement :\n📧 ethan@beliveacademy.com`;

  // ── SALUTATIONS ────────────────────────────────────────────────────────────
  if(l.includes("bonjour")||l.includes("salut")||l.includes("coucou")||l.includes("hello")||l.includes("yo"))
    return`Salut ! 👋 Je suis ton coach live dédié — spécialisé TikTok Live, Twitch et YouTube Live.\n\nJe peux t'aider sur :\n🎯 Affiliation & monétisation\n📈 Viewers & croissance\n🎮 Choix des jeux / catégories\n💰 Diamants, cadeaux, dons TikTok\n🤝 Partenariats & deals\n🎙️ Setup technique\n📡 OBS, encodage, bitrate\n⏰ Horaires optimaux\n🔥 Engagement & fidélisation du chat\n📱 TikTok LIVE spécifique\n\nQu'est-ce que tu veux améliorer ?`;

  // ── TIKTOK LIVE SPÉCIFIQUE ─────────────────────────────────────────────────
  if(l.includes("tiktok live")||l.includes("tiktok")||l.includes("live tiktok")||(l.includes("live")&&l.includes("tik")))
    return`TikTok Live — tout ce qu'il faut savoir :\n\n**Débloquer le Live :**\n• 1000 followers minimum\n• Compte actif depuis +30 jours\n• Application à jour\n\n**Algorithme TikTok Live :**\nTikTok pousse les lives avec :\n✅ Minimum 10 viewers simultanés\n✅ Beaucoup d'interactions (cadeaux, commentaires)\n✅ Durée minimum 30 minutes\n✅ Lives réguliers aux mêmes horaires\n\n**Meilleurs créneaux TikTok FR :**\n• 12h–14h : pause déjeuner\n• 18h–20h : retour école/boulot\n• 21h–23h ✅ : pic d'audience\n\n**Croître vite :**\n• Fais des duets et lives à deux avec d'autres créateurs\n• Réponds à chaque commentaire pendant le live\n• Lance des défis ou questions à ton audience\n• Utilise les bonnes catégories (Gaming, IRL, Talk...)\n\n📧 Pour un accompagnement personnalisé TikTok Live : ethan@beliveacademy.com`;

  // ── DIAMANTS TIKTOK ────────────────────────────────────────────────────────
  if(l.includes("diamant")||l.includes("diamond")||l.includes("cadeau")||l.includes("gift")||l.includes("rose")||l.includes("lion")||l.includes("univers"))
    return`Les diamants TikTok — comment ça marche :\n\n**Conversion :**\n• 1 pièce TikTok = 0,01€ environ\n• Les cadeaux sont convertis en diamants\n• 1 diamant ≈ 0,005€ (TikTok garde ~50%)\n• Seuil de retrait : 100€ minimum\n\n**Cadeaux les plus rentables :**\n🦁 Lion = 29 999 pièces ≈ 150€\n🚀 Rocket = 20 000 pièces ≈ 100€\n🌌 Universe = 34 999 pièces ≈ 175€\n🌹 Rose = 1 pièce — symbolique mais fréquent\n\n**Comment maximiser les cadeaux :**\n• Remercie chaque cadeau vocalement et par le prénom\n• Crée des objectifs visuels (ex: "Si on atteint 100 roses je fais X")\n• Les top gifters méritent une attention spéciale\n• Mets des objectifs de cadeaux dans ton titre\n\n**Seuil de paiement :**\nTikTok paie tous les 15 du mois via PayPal ou virement.\n\n📧 Pour optimiser tes revenus live : ethan@beliveacademy.com`;

  // ── AFFILIATION TWITCH ─────────────────────────────────────────────────────
  if(l.includes("affili")||l.includes("affiliate")||l.includes("partenaire twitch")||l.includes("partner twitch"))
    return`Affiliation Twitch — conditions exactes :\n\n✅ **50 followers**\n✅ **500 minutes** streamées sur 30 jours\n✅ **7 jours** de stream différents sur 30 jours\n✅ **3 viewers moyens** simultanés\n\n**Le plus dur : les 3 viewers moyens.**\n\nComment y arriver vite :\n• Invite 3–5 amis à regarder tes premiers streams\n• Annonce chaque stream 1h avant sur tes réseaux\n• Streame en heures de pointe (20h–23h)\n• Rejoins des Discord de streamers pour du soutien mutuel\n• Fais des raids sortants — les autres te raident en retour\n\n**Après l'affiliation :**\n• Subs à 2,50€ (tu gardes 50%)\n• Bits (1 bit = 0,01$)\n• Emotes personnalisées\n• Mode sub-only\n\n**Partenariat Twitch (niveau supérieur) :**\n• 75 viewers moyens minimum\n• Streame au moins 25h sur 30 jours\n• Streame au moins 12 jours différents\n\n📧 Pour atteindre l'affiliation plus vite : ethan@beliveacademy.com`;

  // ── VIEWERS / AUDIENCE ─────────────────────────────────────────────────────
  if(l.includes("viewer")||l.includes("audience")||l.includes("regarder")||l.includes("spectateur")||l.includes("concurrent"))
    return`Avec ${avg||3} viewers en moyenne — voilà les leviers concrets :\n\n**Actions immédiates :**\n• Parle en permanence même si personne ne regarde — les gens restent si tu es actif\n• Pose une question ouverte toutes les 5 minutes\n• Remercie chaque nouveau viewer par son pseudo\n• Garde un rythme élevé — pas de silence de plus de 10 secondes\n\n**Cette semaine :**\n• Lance 3 raids ciblés vers des streamers de ta taille\n• Poste un clip de tes meilleurs moments sur TikTok\n• Rejoins 2–3 Discord de créateurs dans ta niche\n\n**Ce mois :**\n• Horaires fixes = viewers fidèles (ils reviennent par habitude)\n• Co-stream avec un streamer de même niveau\n• Fais des lives thématiques (ex: "Je joue que des jeux que tu choisis")\n\n**Outils utiles :**\n• TwitchTracker.com — analyse tes stats\n• StreamElements — overlay et alerts\n• Streamlabs — gestion des donations\n\n📧 Pour une stratégie viewers personnalisée : ethan@beliveacademy.com`;

  // ── TITRE / DESCRIPTION ────────────────────────────────────────────────────
  if(l.includes("titre")||l.includes("title")||l.includes("description")||l.includes("tags")||l.includes("tag"))
    return`Optimiser ton titre de stream :\n\n**La formule qui marche :**\n[Jeu/Catégorie] — [Ce que tu fais] + [Émotion/Défi]\n\nExemples ❌ :\n• "Warzone ce soir"\n• "On joue ensemble"\n• "Live gaming"\n\nExemples ✅ :\n• "Warzone ranked — Je monte Diamond ou je delete le jeu 💀"\n• "Minecraft hardcore — 1 mort = stream terminé"\n• "Valorant — Coach gratuit pour les viewers !"\n\n**Pourquoi ça marche :**\nLes titres avec un défi ou une promesse = +40% de clics\n\n**Tags Twitch — les plus efficaces FR :**\nFrançais, Gaming, Compétitif, Débutant, Interactif, Communauté\n\n**Thumbnail YouTube Live :**\n• Visage expressif en gros plan\n• Texte court en gras (max 4 mots)\n• Couleurs vives qui contrastent\n\n📧 Pour des titres optimisés selon ton style : ethan@beliveacademy.com`;

  // ── OBS / ENCODAGE / TECHNIQUE ─────────────────────────────────────────────
  if(l.includes("obs")||l.includes("encodage")||l.includes("bitrate")||l.includes("fps")||l.includes("résolution")||l.includes("lag")||l.includes("freeze")||l.includes("qualité stream")||l.includes("paramètre"))
    return`Paramètres OBS optimaux pour streamer :\n\n**Résolution & FPS :**\n• 1080p60 → bitrate 6000 kbps (upload min 8 Mbps)\n• 1080p30 → bitrate 4500 kbps (upload min 6 Mbps)\n• 720p60 → bitrate 4500 kbps (upload min 6 Mbps) ✅ Recommandé pour débuter\n\n**Encodeur :**\n• Nvidia GPU → NVENC (meilleur rapport qualité/CPU)\n• AMD GPU → AMF\n• Pas de GPU dédié → x264 (charge le CPU)\n\n**Paramètres clés OBS :**\n• Keyframe interval : 2\n• Profile : High\n• Tune : zerolatency\n• Audio : 160 kbps, 48kHz\n\n**Si le stream lag ou freeze :**\n1. Baisse le bitrate de 500 en 500\n2. Passe de 1080p à 720p\n3. Désactive les captures inutiles dans OBS\n4. Ferme tout programme en arrière-plan\n5. Branche en ethernet (pas wifi)\n\n**Outils de test :**\n• fast.com → teste ton upload\n• Twitch Inspector → analyse ton stream en live\n\n📧 Pour un audit de ton setup complet : ethan@beliveacademy.com`;

  // ── SETUP MATÉRIEL ─────────────────────────────────────────────────────────
  if(l.includes("setup")||l.includes("micro")||l.includes("caméra")||l.includes("camera")||l.includes("materiel")||l.includes("matériel")||l.includes("éclairage")||l.includes("lumière")||l.includes("casque")||l.includes("écran"))
    return`Setup streaming — priorités dans l'ordre :\n\n**1. 🎙️ Audio — Le plus important**\nUn mauvais micro = les viewers partent immédiatement.\n• Budget serré (50€) : HyperX SoloCast\n• Bon rapport qualité/prix (80€) : Blue Snowball iCE\n• Pro (150€) : HyperX QuadCast S\n\n**2. 📡 Connexion**\n• Minimum 6 Mbps upload\n• Ethernet obligatoire — le wifi crée des freezes\n• Test sur fast.com\n\n**3. 💡 Éclairage**\n• Ring light 30cm à 20€ → change tout\n• Lumière face à toi, jamais derrière\n• Kelvin 5000–6000 = lumière naturelle\n\n**4. 📷 Caméra**\n• Pas obligatoire pour débuter\n• Budget (60€) : Logitech C920\n• Meilleur (150€) : Logitech C922\n• Top (300€+) : Sony ZV-E10 avec Elgato Cam Link\n\n**5. 🖥️ PC**\n• CPU minimum : Ryzen 5 3600 / i5-10400\n• RAM : 16GB minimum\n• GPU : GTX 1660 ou mieux\n\n📧 Pour un audit de ton setup selon ton budget : ethan@beliveacademy.com`;

  // ── HORAIRES ───────────────────────────────────────────────────────────────
  if(l.includes("horaire")||l.includes("heure")||l.includes("quand streamer")||l.includes("quel moment")||l.includes("créneau"))
    return`Meilleurs créneaux streaming FR :\n\n**Twitch :**\n• 19h–20h : Bon créneau, peu de concurrence\n• 20h–23h ✅ : Peak time — meilleur créneau\n• Weekend 15h–17h : Audience ado/jeune\n\n**TikTok Live :**\n• 12h–14h : Pause déjeuner ✅\n• 18h–20h : Retour école/boulot ✅\n• 21h–23h : Pic d'audience ✅\n• Évite 2h–10h sauf si audience internationale\n\n**YouTube Live :**\n• 20h–22h en semaine\n• 15h–18h le weekend\n• Annonce 48h à l'avance pour maximiser les rappels\n\n**La règle d'or :**\nLa régularité > le timing.\nStreame toujours aux mêmes heures → les viewers reviennent par habitude, comme une émission TV.\n\n**Fréquence recommandée :**\n• Minimum : 3 fois/semaine\n• Idéal : 5 fois/semaine\n• Pro : tous les jours\n\n📧 Pour analyser les meilleurs créneaux dans ta niche : ethan@beliveacademy.com`;

  // ── MONÉTISATION ───────────────────────────────────────────────────────────
  if(l.includes("argent")||l.includes("monetis")||l.includes("gagner")||l.includes("revenu")||l.includes("salaire")||l.includes("payer")||l.includes("rémunér"))
    return`Monétisation streaming — toutes les sources :\n\n**🎮 Twitch :**\n• Subs : 2,50€ / 5€ / 25€ (tu gardes 50%)\n• Bits : 1 bit = 0,01$\n• Ads : 0,50€–3€ pour 1000 views\n• Hype Train : boost de communauté\n\n**📱 TikTok Live :**\n• Diamants via cadeaux (TikTok garde ~50%)\n• Seuil retrait : 100€ minimum\n• Meilleur retour : lives longs avec gros gifters\n\n**▶️ YouTube Live :**\n• Super Chat : dons mis en avant dans le chat\n• Membres : abonnement mensuel\n• Ads sur le replay\n\n**💰 La vraie source de revenus : les partenariats**\n• 0–200 followers : codes promo affiliation (GFuel, Kinguin)\n• 200–500 : produits offerts\n• 500–1000 : premiers deals rémunérés (50€–300€)\n• 1000+ : sponsoring régulier (300€–2000€ par deal)\n\n**Dons directs :**\n• Streamlabs — le plus utilisé\n• Ko-fi — alternatif sans commission\n• PayPal.me — simple et direct\n\n📧 Pour trouver et négocier tes premiers partenariats : ethan@beliveacademy.com`;

  // ── PARTENARIATS / SPONSORS ────────────────────────────────────────────────
  if(l.includes("partenariat")||l.includes("sponsor")||l.includes("deal")||l.includes("marque")||l.includes("collaboration")||l.includes("contrat"))
    return`Partenariats — comment ça marche :\n\n**Les paliers réalistes :**\n• 0–200 followers → Affiliation (codes promo, pas d'argent)\n• 200–500 → Produits offerts (valeur 20–100€)\n• 500–1000 → Premiers deals rémunérés (50–300€)\n• 1000–5000 → Deals réguliers (300–1000€)\n• 5000+ → Sponsoring sérieux (1000€+)\n\n**Marques qui dealent avec des petits créateurs FR :**\nGFuel, Kinguin, NordVPN, ExpressVPN, G2A, Corsair, HyperX, SteelSeries, Discord Nitro\n\n**Comment prospecter :**\n1. Crée un media kit (stats + audience + tarifs)\n2. Contacte par email pro ou DM Instagram/Twitter\n3. Commence par les marques gaming\n4. Propose un deal test (1 stream) avant un contrat long\n\n**Ce qu'ils regardent :**\n• Engagement > nombre de followers\n• Régularité des streams\n• Qualité de l'audience (pas de bots)\n• Niche claire\n\n📧 Belive Academy prospecte et négocie les partenariats pour toi : ethan@beliveacademy.com`;

  // ── CROISSANCE / FOLLOWERS ─────────────────────────────────────────────────
  if(l.includes("follower")||l.includes("croissance")||l.includes("grow")||l.includes("grandir")||l.includes("progresser")||l.includes("abonné")||l.includes("abonnés"))
    return`Croissance — les 3 leviers qui marchent vraiment :\n\n**1. 🎬 Contenu court (impact immédiat)**\n• Clipe tes meilleurs moments (kills, rage, moments drôles)\n• Poste sur TikTok et YouTube Shorts\n• Format idéal : 30–60 secondes, vertical\n• Un bon clip peut t'amener 50–500 followers en une nuit\n\n**2. 🤝 Le réseau (effet boule de neige)**\n• Raids ciblés vers des streamers de ta taille\n• Co-streams avec des créateurs complémentaires\n• Rejoins des serveurs Discord de créateurs\n• Commente les streams des autres (visibilité)\n\n**3. 📅 La régularité (fidélisation)**\n• Streame aux mêmes horaires — les viewers reviennent par habitude\n• Annonce chaque stream sur tes réseaux 1h avant\n• Crée des rendez-vous (ex: "Chaque mardi tournoi communauté")\n\n**Ce qui ne marche pas :**\n❌ Acheter des followers (fake, détruit l'algorithme)\n❌ Follow for follow (audience non ciblée)\n❌ Streamer sans horaires fixes\n\n📧 Pour une stratégie de croissance complète : ethan@beliveacademy.com`;

  // ── ENGAGEMENT / CHAT ──────────────────────────────────────────────────────
  if(l.includes("chat")||l.includes("engagement")||l.includes("interaction")||l.includes("communauté")||l.includes("fidéliser")||l.includes("moderateur")||l.includes("modérateur")||l.includes("bot")||l.includes("nightbot")||l.includes("streamelements"))
    return`Engagement et gestion du chat :\n\n**Animer le chat :**\n• Pose une question ouverte toutes les 5–10 minutes\n• Crée des polls réguliers (jeu suivant, décision en live...)\n• Lis chaque message à voix haute quand le chat est petit\n• Lance des débats (ex: "PC vs Console — qui vote quoi ?")\n• Remercie les nouveaux abonnés avec une réaction personnalisée\n\n**Bots recommandés :**\n• Nightbot — le plus simple, gratuit\n• StreamElements — complet, overlay + bot\n• Fossabot — avancé, très personnalisable\n\n**Commandes utiles à créer :**\n!discord → lien Discord\n!reseaux → tous tes liens\n!objectif → ton prochain objectif de followers\n!clip → comment clipper\n\n**Modération :**\n• Nomme 1–2 modérateurs de confiance dès le début\n• Configure le filtre anti-spam auto dans Twitch/TikTok\n• Règles claires affichées dans le panneau\n\n**Fidéliser :**\n• Retiens les noms de tes viewers réguliers\n• Crée un Discord communauté dès que possible\n• Fais des events exclusifs (tournois, soirées communauté)\n\n📧 Pour une stratégie communauté : ethan@beliveacademy.com`;

  // ── RAID ───────────────────────────────────────────────────────────────────
  if(l.includes("raid")||l.includes("host")||l.includes("co-stream")||l.includes("costream"))
    return`Raids et co-streams — stratégie :\n\n**Pourquoi raider :**\n• Tu envoies ton audience à un autre streamer en fin de live\n• En retour ils te raidont à leur prochaine fin de live\n• C'est le meilleur réseau gratuit sur Twitch\n\n**Comment choisir qui raider :**\n✅ Même taille que toi (± 50% de viewers)\n✅ Même type de contenu ou complémentaire\n✅ Streame en direct au moment où tu termines\n✅ Quelqu'un que tu connais / avec qui tu as interagi\n\n❌ Pas les gros streamers (ton audience se dilue)\n❌ Pas au hasard (perds tes viewers)\n\n**Co-stream :**\n• Streame en même temps qu'un autre créateur sur le même jeu ou sujet\n• Partagez vos liens mutuellement avant de commencer\n• Les deux audiences se mélangent = croissance mutuelle\n\n**Commande Twitch :**\n/raid [pseudo] → lance le raid en fin de stream\n\n📧 Pour intégrer un réseau de créateurs Belive : ethan@beliveacademy.com`;

  // ── JEUX / CATÉGORIES ──────────────────────────────────────────────────────
  if(l.includes("jeu")||l.includes("game")||l.includes("jouer")||l.includes("catégorie")||l.includes("niche")||l.includes("contenu"))
    return`Choix du jeu — la stratégie gagnante :\n\n**Règle d'or :**\nVise des catégories avec 200–800 viewers totaux sur Twitch → tu apparais en haut de la liste → visibilité maximale.\n\n**Bons choix actuellement FR :**\n• Brawl Stars — communauté FR fidèle, peu saturée\n• Valorant ranked — clips viraux faciles\n• Minecraft créatif / survie — niche fidèle\n• FIFA FUT — gros pic d'audience le soir\n• Escape From Tarkov — audience très engagée\n• Jeux indés récents — peu de concurrence\n\n**À éviter si tu débutes :**\n❌ Fortnite — trop de concurrence\n❌ GTA RP — presque impossible à percer\n❌ League of Legends — sursaturé\n❌ Warzone — audience déjà captive ailleurs\n\n**IRL / Just Chatting :**\n• Nécessite une vraie personnalité / storytelling\n• Fonctionne bien sur TikTok Live\n• À tenter après avoir une base de viewers\n\n**Conseil :**\nChoisis un jeu que tu connais BIEN — les viewers sentent si tu forces.\n\n📧 Pour analyser ta niche idéale : ethan@beliveacademy.com`;

  // ── RÉSEAUX SOCIAUX ────────────────────────────────────────────────────────
  if(l.includes("réseau")||l.includes("instagram")||l.includes("youtube")||l.includes("twitter")||l.includes("x.com")||l.includes("clip")||l.includes("short")||l.includes("reels")||l.includes("multistream")||l.includes("multi stream")||l.includes("restream"))
    return`Stratégie multi-plateforme :\n\n**Le bon setup :**\n🎮 Twitch/TikTok → Stream principal + communauté\n🎵 TikTok → Clips viraux + nouvelle audience\n▶️ YouTube → Highlights + référencement long terme\n📸 Instagram → Personal branding + backstage\n🐦 Twitter/X → Annonces + contact marques\n\n**La règle des 80/20 :**\n80% de ton énergie sur ta plateforme principale\n20% à recycler le contenu sur les autres\n\n**Recycler un stream en contenu :**\n1. Stream → clip les meilleurs moments (30–60s)\n2. TikTok/Shorts → poste le clip en vertical\n3. YouTube → upload le VOD en highlight\n4. Instagram → extrait en Reels\n\n**Multistreamer (streamer sur plusieurs plateformes en même temps) :**\n• Restream.io — gratuit jusqu'à 2 plateformes\n• Streamyard — interface simple, payant\n• OBS + plugin → Twitch + YouTube simultané\n\n⚠️ Twitch a des règles sur le multistream — vérifie si t'es affilié ou partenaire.\n\n📧 Pour une stratégie cross-plateforme complète : ethan@beliveacademy.com`;

  // ── ALGORITHME ─────────────────────────────────────────────────────────────
  if(l.includes("algorithme")||l.includes("algo")||l.includes("visibilité")||l.includes("découverte")||l.includes("recommandation")||l.includes("suggestion"))
    return`Comment fonctionnent les algorithmes live :\n\n**Twitch :**\nTwitch trie par nombre de viewers → si t'as peu de viewers, vise des catégories peu peuplées (200–800 viewers totaux) pour apparaître en haut.\n• Bonus si tu streames régulièrement\n• Clips mis en avant = boost de visibilité\n• Raids entrants = signal positif\n\n**TikTok Live :**\nTikTok pousse les lives avec :\n✅ Minimum 10 viewers simultanés\n✅ Beaucoup d'interactions (cadeaux, commentaires, partages)\n✅ Durée minimum 30 min\n✅ Peu de gens qui quittent (taux de rétention)\n\n**YouTube Live :**\n• Annonce le live 48h avant → YouTube crée des rappels\n• Thumbnail et titre optimisés (mots-clés dans le titre)\n• Les replays sont indexés → trafic organique longtemps après\n\n**Ce qui booste sur toutes les plateformes :**\n✅ Régularité\n✅ Taux de rétention élevé (gens qui restent longtemps)\n✅ Interactions fréquentes\n✅ Partages externes\n\n📧 Pour une stratégie algorithmique personnalisée : ethan@beliveacademy.com`;

  // ── BANNISSEMENT / PROBLÈMES PLATEFORMES ──────────────────────────────────
  if(l.includes("banni")||l.includes("ban")||l.includes("suspendu")||l.includes("suspension")||l.includes("dmca")||l.includes("copyright")||l.includes("signalement")||l.includes("report"))
    return`Problèmes de bannissement / suspension :\n\n**DMCA / Copyright (musique) :**\n• Twitch mute les VODs avec de la musique copyrightée\n• Utilise de la musique libre de droits : Epidemic Sound, Monstercat, Pretzel.rocks\n• Si t'as un strike DMCA : supprime le VOD concerné rapidement\n\n**Suspension Twitch :**\n• 1er ban : 1–3 jours en général\n• 2ème ban : 7–30 jours\n• 3ème ban : permanent possible\n• Appel via : twitch.tv/user/legal\n\n**Suspension TikTok :**\n• Appel dans l'app → Profil → Aide → Signaler un problème\n• Délai : 2–7 jours\n• Crée un compte backup en attendant\n\n**Éviter les problèmes :**\n✅ Pas de musique copyrightée\n✅ Pas de contenu pour adultes\n✅ Pas de harcèlement / hate speech\n✅ Respecte les CGU de chaque plateforme\n✅ Modère bien ton chat\n\n📧 Pour de l'aide sur un problème de compte : ethan@beliveacademy.com`;

  // ── STRESS / MOTIVATION ────────────────────────────────────────────────────
  if(l.includes("motivat")||l.includes("décourager")||l.includes("découragé")||l.includes("abandonner")||l.includes("arrêter")||l.includes("difficile")||l.includes("dur")||l.includes("personne regarde")||l.includes("0 viewer")||l.includes("zéro viewer"))
    return`C'est normal de se décourager — voilà la réalité :\n\n**Les chiffres vrais :**\n• 95% des streamers ont moins de 5 viewers leurs 6 premiers mois\n• Les plus gros streamers FR ont tous streamé des heures devant 0 personne\n• La croissance est exponentielle : lente au début, rapide après un seuil\n\n**Ce que tu dois faire maintenant :**\n• Streame pour toi d'abord — l'audience sent si tu forces\n• Fixe-toi des objectifs atteignables (10 followers ce mois, pas 1000)\n• Documente ta progression — relis dans 6 mois\n• Rejoins une communauté de streamers pour ne pas être seul\n\n**Le vrai problème quand il y a 0 viewer :**\nC'est souvent un problème de visibilité, pas de qualité.\n→ Mauvaise catégorie trop concurrentielle\n→ Pas d'annonce sur les réseaux avant le stream\n→ Horaires irréguliers\n\n**Citation qui aide :**\n"Streame comme si 1000 personnes regardaient — un jour ce sera vrai."\n\n📧 On est là pour t'accompagner : ethan@beliveacademy.com`;

  // ── OVERLAYS / ALERTS ──────────────────────────────────────────────────────
  if(l.includes("overlay")||l.includes("alert")||l.includes("alerte")||l.includes("streamlabs")||l.includes("streamelements")||l.includes("widget")||l.includes("habillage")||l.includes("écran"))
    return`Overlays et alerts — guide complet :\n\n**Les outils gratuits :**\n• StreamElements — overlays + alerts + bot tout-en-un ✅\n• Streamlabs — très complet, un peu plus lourd\n• Canva — pour créer des visuels statiques\n\n**Ce dont tu as besoin minimum :**\n✅ Overlay principal (webcam + infos en bas)\n✅ Alert nouveaux followers\n✅ Alert nouveaux subs\n✅ Alert nouveaux dons\n✅ Scène "BRB" (Be Right Back)\n✅ Scène "Fin de stream"\n\n**Ce qui attire l'œil :**\n• Animations courtes (max 3 secondes)\n• Son d'alert reconnaissable\n• Couleurs cohérentes avec ta charte\n• Pas trop chargé — le jeu doit rester lisible\n\n**Thèmes gratuits :**\n• Nerd or Die — free overlays de qualité\n• Own3d.tv — collection gratuite et payante\n• StreamElements library — directement dans l'outil\n\n📧 Pour un habillage visuel pro : ethan@beliveacademy.com`;

  // ── FALLBACK LIVE ──────────────────────────────────────────────────────────
  const motsLive=["stream","live","twitch","tiktok","youtube","viewers","followers","obs","gaming","créateur","contenu","jeu","jouer","plateforme","monétisation","affiliation","partenariat","audience","chat","raid","clip","short","reels","algorithme","overlay","alert","setup","micro","caméra","bitrate","fps","encodage","diamant","cadeau","gift","abonné","sub","bits","donation","don"];
  const estLie=motsLive.some(m=>l.includes(m));

  if(estLie)
    return`Bonne question sur le streaming ! Pour te donner une réponse précise j'ai besoin de plus de détails.\n\nJe peux t'aider sur :\n🎮 TikTok Live, Twitch, YouTube Live\n📈 Viewers, croissance, algorithme\n💰 Monétisation, diamants, partenariats\n🎯 Affiliation Twitch\n🎙️ Setup, OBS, encodage\n🔥 Engagement, chat, communauté\n⏰ Horaires, régularité\n📱 Réseaux sociaux, clips\n\nPrécise ta question et je te donne une réponse concrète !\n\n📧 Pour un accompagnement personnalisé : ethan@beliveacademy.com`;

  // ── HORS SUJET ABSOLU ──────────────────────────────────────────────────────
  return`❌ Cette question ne concerne pas le live streaming ou la création de contenu.\n\nJe suis uniquement spécialisé dans :\n🎮 TikTok Live, Twitch, YouTube Live\n📈 Croissance et monétisation de streamers\n🤝 Partenariats créateurs\n🎙️ Setup et technique streaming\n\nPour toute autre demande, contacte notre agence :\n📧 ethan@beliveacademy.com\nOn sera heureux de t'aider !`;
};
const CTR=(c,ct)=>{
  const revenus=[];
