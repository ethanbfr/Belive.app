...
}catch(e){console.log(“Supabase code save failed, using localStorage”);}
        ...
        <div>
          ...
          <Card style={{marginBottom:20}}>
            ...
            <div style={{display:"flex",gap:10,alignItems:"center",marginBottom:12}}>
              <Btn full onClick={()=>{genCode(codeType,freeType,freeDays,codeCreatorName);setCodeCreatorName("");}} icon="🔄">
